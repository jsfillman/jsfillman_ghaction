...
This sample module contains one small method that filters contigs.
    ...
    def run_jsfillman_ghaction(self, ctx, params):
        """
        ...
        #BEGIN run_jsfillman_ghaction

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_jsfillman_ghaction function. Params=' + pformat(params))
        ...
        #END run_jsfillman_ghaction

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_jsfillman_ghaction return value ' +
